...
class BurnMetalExchangeTokenFlow : ClientStartableFlow{
    ...
    override fun call(requestBody: ClientRequestBody): String {
        ...
        try{
            val (symbol, issuer, amount) = requestBody.getRequestBodyAs(
                jsonMarshallingService, BurnMetalExchangeTokenFLowArgs::class.java
            )
            ...
            val txBuilder : UtxoTransactionBuilder =
                if (change.compareTo(BigDecimal.ZERO) > 0) {
                    ...
                    ledgerService.createTransactionBuilder()
                        ...
                        .addOutputStates(MetalExchangeStateChange)
                        .addCommand(MetalExchangeContract.Burn())
...
data class BurnMetalExchangeTokenFLowArgs(
    var symbol: String,
