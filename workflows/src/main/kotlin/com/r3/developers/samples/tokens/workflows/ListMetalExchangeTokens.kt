...
// This flow is used to list all the MetalExchange tokens available in the vault.
class ListMetalExchangeTokens: ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        val states = utxoLedgerService.findUnconsumedStatesByType(
            MetalExchangeState::class.java
        )

        // Queries the VNode's vault for unconsumed states and converts the result to a serializable DTO.
        val results = states.stream().map{
            MetalExchangeStateList(
...
RequestBody for triggering the flow via http-rpc:
{
    ...
    "flowClassName": "com.r3.developers.samples.tokens.workflows.ListMetalExchangeTokens",
    "requestBody": {}
}
*/


data class MetalExchangeStateList(
