...
import com.r3.developers.samples.tokens.contracts.MetalExchangeContract.Issue
...
class IssueMetalExchangeTokenFlow : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        try{
            ...
            val (symbol, amount, owner) = requestBody.getRequestBodyAs(
                ...
                IssueMetalExchangeTokenFlowArgs::class.java
            )
            ...
            val MetalExchangeState = MetalExchangeState(
            ...
            val txBuilder = ledgerService.createTransactionBuilder()
                ...
                .addOutputState(MetalExchangeState)
                .addCommand(Issue())
            ...
            return flowEngine.subFlow<String>(FinalizeMetalExchangeTokenSubFlow(signedTransaction, ownerMember.name))
...
RequestBody for triggering the flow via REST:
{
    ...
    "flowClassName": "com.r3.developers.samples.tokens.workflows.IssueMetalExchangeTokensFlow",
    "requestBody": {
        "symbol": "MetalExchange",
...
data class IssueMetalExchangeTokenFlowArgs(
    val symbol: String,
    val amount: String,
